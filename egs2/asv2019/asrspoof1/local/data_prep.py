...
if __name__ == "__main__":
    ...
    src_wav_path = os.path.join(args.src_folder, "LA", "ASVspoof2019_LA_{}".format(args.subset), "flac")
    if args.subset == "train":
        src_label_path = os.path.join(args.src_folder, "LA", "ASVspoof2019_LA_cm_protocols", "ASVspoof2019.LA.cm.{}.trn.txt".format(args.subset))
    else:
        src_label_path = os.path.join(args.src_folder, "LA", "ASVspoof2019_LA_cm_protocols", "ASVspoof2019.LA.cm.{}.trl.txt".format(args.subset))
